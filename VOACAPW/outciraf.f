...
C
     ...
     C SNRLW(13), SNRUP(13), SPROB(13), VHIGH(13), RNEFF(13),MDL(13)
      ...
      character alfs(23)*6,alfPwr*10,label*90,path*5,daily*3
...
ccc      write(alfs(19),'(f6.1)') xlimit6(dbw(1)+30.,1)         !  DBM
      ...
      if(nf.eq.1) then
      write(LUO,'(2i3,2f10.4,23a6)') ix,iy,rlatd,rlongd,alfs
      else
      write(LUO,'(2i3,2f10.4,23a6)') ix,iy,rlatd,rlongd,alfs(1),alfs(8),
